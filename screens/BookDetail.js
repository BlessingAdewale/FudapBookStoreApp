    ...
    function renderBookInfoSection() {
      return (
          <View style={{ flex: 1 }}>
              ...
              {/* Navigation header */}
              <View style={{ flexDirection: 'row', paddingHorizontal: SIZES.radius, height: 80, alignItems: 'flex-end', color:COLORS.white }}>
                  <TouchableOpacity
              ...
              >
                  ...
                  <View style={{ flex: 1, alignItems: 'center' }}>
                      <Text style={{ ...FONTS.h3, color: COLORS.white }}>4.7</Text>
                  ...
                  {/* Language */}
                  <View style={{ flex: 1, alignItems: 'center' }}>
                      <Text style={{ ...FONTS.h3, color: COLORS.white }}>Eng</Text>
